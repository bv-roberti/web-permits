...
import { AlvaraTableRow } from "../../../sections/@dashboard/alvara/list";
...
const TABLE_HEAD = [
  { id: "invoiceNumber", label: "Regional", align: "left" },
  { id: "createDate", label: "Empresa", align: "left" },
  { id: "dueDate", label: "UF", align: "left" },
  { id: "price", label: "Tipo Licenca", align: "center", width: 140 },
  { id: "sent", label: "N Licenca", align: "center", width: 140 },
  { id: "status", label: "Vencimento", align: "left" },
  { id: "status", label: "Status", align: "left" },
  { id: "status", label: "Responsavel", align: "left" },
  { id: "" },
];
...
export default function InvoiceList() {
  ...
  const TABS = [
    { value: "all", label: "Geral", color: "info", count: tableData.length },
    {
      value: "paid",
      label: "Regular",
      color: "success",
  ...
  return (
    <Page title="Invoice: List">
      <Container maxWidth={themeStretch ? false : "lg"}>
        <HeaderBreadcrumbs
          heading="Lista de documentos"
          links={[
            { name: "Alvaras", href: PATH_DASHBOARD.invoice.root },
            { name: "Lista" },
          ]}
          action={
        ...
        <Card>
          ...
          <InvoiceTableToolbar
            ...
            optionsService={DOCUMENT_STATUS}
          />
